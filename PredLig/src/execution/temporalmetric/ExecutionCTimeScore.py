...
from calculating.CalculatingTogetherCTimeScore import CalculatingTogetherCTimeScore
...
def execution(configFile):
    ...
    calc = CalculatingTogetherCTimeScore(myparams, nodeSelection.nodesNotLinked)
